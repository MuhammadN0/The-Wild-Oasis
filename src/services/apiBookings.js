...
export async function getBookings( {filter, sortBy, page}) {
  ...
  //Filter query based on the filter and filter field
  if(filter) query = query[filter.method](filter.field, filter.filterProperty)
  //Sort query based on sortBy 
  if(sortBy) query = query.order(sortBy.field, {ascending: sortBy.asc === 'asc'})
  //Pagination
  if(page){
